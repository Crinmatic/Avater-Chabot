...
class AIAssistantServer:
    ...
    async def generate_response(self, user_message: str, history: list) -> str:
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": """You are AvatarConnect, an empathetic emotional support companion created by leeLab. Your purpose is to provide compassionate, non-judgmental support to people experiencing difficult emotions.
